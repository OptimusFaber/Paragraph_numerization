    ...
    for elem in t.keys():
        if elem == 'Paragraphs':
            for e in range(len(t[elem])):
                if t[elem][e]['Errors']:
                    for p in range(len(t[elem][e]['Errors'])):
                        report.append({"Error": t[elem][e]['Errors'][p]["Description"],
                                        "Feedback": t[elem][e]['Errors'][p]["Type"]})

                if t[elem][e]['Entities']:
                    for j in range(len(t[elem][e]['Entities'])):
                        if not t[elem][e]['Entities'][j]["IsSkip"]:
                            if NpaNta and t[elem][e]['Entities'][j]['Status'] == 'Actual':
                                continue
                ...
                for cell in range(len(t[elem][e]['Rows'])):
                    for c in range(len(t[elem][e]['Rows'][cell]['Cells'])):
                        for g in range(len(t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"])):
                            if t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors']:
                                for p in range(len(t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors'])):
                                    report.append({"Error": t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors'][p]["Description"],
                                                    "Feedback": t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors'][p]["Type"]})
                            ...
                            if t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities']:
                                for j in range(len(t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'])):
                                    if not t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j]["IsSkip"]:
                                        if NpaNta and t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j]['Status'] == 'Actual':
                                            continue
                                        report.append({"Error": "Неверные сущности",

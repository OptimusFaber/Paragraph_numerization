                ...
                for e in range(len(t[elem])):
                    ...
                    if t[elem][e]['Entities']:
                        for j in range(len(t[elem][e]['Entities'])):
                            mistake = compare_single_text(json=t[elem][e]['Entities'][j], log_path=global_log_path, txt_path=json_path)
                            ...
                            for g in range(len(t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"])):
                                ...
                                if t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities']:
                                    for j in range(len(t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'])):
                                        mistake = compare_single_text(json=t[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j], log_path=global_log_path, txt_path=json_path)
                                        if mistake and mistake is not None:

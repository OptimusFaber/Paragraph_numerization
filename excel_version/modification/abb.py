            ...
            try:
                ...
                if dicts:
                    ...
                    for cor in corr_fac:
                        ...
                        feedback_list.append(["Corruption", sentence, devided_text[i]['Address'], cor[1]])
                    for no in no_conn:
                        sentence = "Фраза «{}»".format(no[1])
                        feedback_list.append(["NoNPA", sentence, devided_text[i]['Address'], no[1]])
                    for inc in inc_frm:
                        sentence = "Фраза «{}»".format(inc[1])
                        feedback_list.append(["IncorrectForm", sentence, devided_text[i]['Address'], inc[1]]) 
                #?------------------------------------------------------------------------------------
                if abbs and buf:
                    ...
                    for r in res:
                        ...
                        feedback_list.append(["Abbreviation", sentence, devided_text[i]['Address'], r])

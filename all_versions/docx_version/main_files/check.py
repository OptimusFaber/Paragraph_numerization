    ...
    def report_gen(self, json_parsed, dictionary):
        for elem in json_parsed.keys():
            if elem == 'Paragraphs':
                ...
                for e in range(len(json_parsed[elem])):
                    for cell in range(len(json_parsed[elem][e]['Rows'])):
                        for c in range(len(json_parsed[elem][e]['Rows'][cell]['Cells'])):
                            for g in range(len(json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"])):
                                if json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Index'] in dictionary.keys():
                                    if json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g].get('Errors') is None:
                                        json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors'] = dictionary[json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Index']]
                                    else:
                                            json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors'].extend(dictionary[json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Index']])
                                else:
                                    if json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g].get('Errors') is None:
                                        json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Errors'] = None
                            
                                if json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities']:
                                    for j in range(len(json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'])):
                                        mistake = compare_single_text(json=json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j], error_path=self.error_path)
                                        if mistake and mistake is not None:
                                            if json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j]['Errors']:
                                                json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j]['Errors'].append(mistake)
                                            else:
                                                json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j]['Errors'] = [mistake]
                                            json_parsed[elem][e]['Rows'][cell]['Cells'][c]["Paragraphs"][g]['Entities'][j]["Status"] = "Unknown"
